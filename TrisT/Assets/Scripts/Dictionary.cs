...
public static class Dictionary
{
    ...
    {
        { Shape.NULL, new Vector2Int[]{ new Vector2Int(0,0)} },
    ...
    private static readonly Vector2Int[,] WallKicksJLOSTZQP = new Vector2Int[,] {
    ...
    {
        { Shape.I, WallKicksI },
        { Shape.J, WallKicksJLOSTZQP },
        { Shape.L, WallKicksJLOSTZQP },
        { Shape.O, WallKicksJLOSTZQP },
        { Shape.S, WallKicksJLOSTZQP },
        { Shape.T, WallKicksJLOSTZQP },
        { Shape.Z, WallKicksJLOSTZQP },
    };
